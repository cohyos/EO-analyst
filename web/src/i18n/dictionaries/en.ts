...
export const en: Dictionary = {
  ...
  morning: {
    ...
    errorsLabel: "Errors",
    errorsAria: "Log errors in the last 24h — open error details",
    ...
    errorsPanelTime: "Time",
    errorsPanelCause: "Cause",
    errorsPanelAction: "Recommended action",
    errorsPanelImpact: "Impact on the run",
    errorsPanelTechnicalDetails: "Technical details",
    errorsPanelErrorType: "Error type",
    errorsPanelTraceback: "Traceback",
    errorsPanelOpenLink: "Open details",
    errorsPanelViewLog: "View full log",
  },
  feed: {
    ...
    investigateConfirmTitle: "Start deep-search investigation",
    investigateConfirmBody: "Open a deep-search investigation for this item? (Takes several minutes and uses a cloud model.)",
  },
  corr: {
  ...
  tenders: {
    ...
    share: {
      trigger: "Share HTML",
      triggerWithForecasts: "Share HTML (with forecasts)",
      disabledTitle: "No tenders to show",
      docTitle: "Tenders & Opportunities — EO-Analyst",
      docTitleWithForecasts: "Tenders & Opportunities and forecasts — EO-Analyst",
      shareFile: "Share HTML file",
      ...
      copiedLinks: "Links copied to clipboard",
  ...
  // PD-ui (docs/PLAN_PRODUCT_DOSSIER.md): "Product Dossiers" -- deep, cited, per-product market
  // dossiers (DossiersPage.tsx + DossierDetailPage.tsx + web/src/components/dossiers/*).
  dossiers: {
    emptyList: "No product dossiers found",
    notFound: "Dossier not found",
    createNew: "New Dossier",
    rerun: "Run Again",
    rerunConfirmTitle: "Rerun this dossier",
    rerunConfirmBody: "A rerun takes about 30-60 minutes",
    detailsLink: "Details",
    openDetailAria: "Open the product dossier for {name}",
    backToList: "← Back to dossiers",
    openReport: "Open report",
    noReportYet: "No report yet for this dossier",
    dealsCount: "{n} deals",
    lastRunLabel: "Last run",
    confidenceLabel: "Confidence: {pct}%",
    compareLink: "Compare",
    runForCompetitor: "Run a dossier for this product",
    selectForCompareAria: "Select {name} for comparison",
    compareSelectedButton: "Compare selected ({n})",
    compareMaxWarning: "You can select up to 3 products to compare",
    outcome: {
      found: "Found",
      partial: "Partial",
      not_found: "Not found",
    ...
    form: {
      ...
      productNamePlaceholder: "e.g. SPECTRO XR",
      productNameRequired: "Product name is required",
      vendorLabel: "Vendor",
      vendorPlaceholder: "e.g. Elbit Systems",
      aliasesLabel: "Aliases",
      aliasesPlaceholder: "Press Enter or comma to add",
      aliasesRemoveAria: "Remove alias {alias}",
      productLineLabel: "Product line",
      productLineNone: "No product line",
      budgetLabel: "Research budget",
      budget1x: "Regular (1x)",
      budget2x: "Double (2x)",
      modelLabel: "Model",
      modelDefault: "Default (configured chain)",
      modelCodex: "Codex",
    ...
    sections: {
      ...
      deals: "Deals",
      pricing: "Pricing",
      pricingEstimate: "Analyst pricing estimate (low confidence)",
      partnerships: "Partnerships",
      competitors: "Competitors",
      claimsReview: "Critical review of vendor claims",
      patents: "Patents",
      tendersAndForecasts: "Tenders & Forecasts",
      risksAndGaps: "Risks & Gaps",
      gapsTracking: "Gap tracking",
      bdImplications: "Business Implications",
    ...
    identity: {
      ...
      firstAnnouncedLabel: "First announced",
      statusLabel: "Status",
    },
    table: {
      ...
      colSources: "Sources",
      colAction: "Action",
      otherSpecifications: "Additional Parameters",
      colConfidence: "Confidence",
      colEvidence: "Evidence",
      colDomain: "Domain",
      colIntegrationEvidence: "Integration evidence",
      colEvent: "Event",
      colClaim: "Claim",
      colVerifiability: "Verifiability",
      colComparability: "Comparability",
      colVerdict: "Verdict",
      colGap: "Gap",
      colMethod: "Method",
      colRange: "Estimate range",
      colComparableProduct: "Comparable product",
    ...
    pricingEstimate: {
      disclaimer: "Analyst estimate, not a sourced figure",
      methodLabel: "Method",
      assumptionsLabel: "Assumptions",
      marketAnchorsLabel: "Market anchors",
      rangeLabel: "Estimate range",
    },
    maturity: {
      trlLabel: "TRL",
      operationalUsersLabel: "Operational users",
      platformsIntegratedLabel: "Integrated platforms",
      firstFieldingLabel: "First fielding",
      noAssessment: "No maturity assessment",
    },
    regulatoryExport: {
      title: "Regulatory & Export",
      regimeLabel: "Export regime",
    ...
    runHistory: {
      ...
      noChanges: "No changes documented in this run",
    },
    emptySections: {
      specifications: "No specification data",
      versions: "No versions documented",
      platforms: "No platforms documented",
      performance: "No performance data",
      timeline: "No timeline events documented",
      deals: "No deals documented",
      pricing: "No pricing data",
      pricingEstimate: "Not enough grounded data (a scoped contract total and a market anchor) to produce an estimate",
      partnerships: "No partnerships documented",
      competitors: "No competitors identified",
      claimsReview: "No vendor claims reviewed",
      patents: "No relevant patents found",
      tendersAndForecasts: "No relevant tenders or forecasts",
      risksAndGaps: "No gaps documented",
      gapsTracking: "No gap-tracking data",
      bdImplications: "No business implications documented",
      whatChanged: "No changes vs. the previous run",
      sources: "No sources documented",
    },
    compare: {
      title: "Compare Products",
      invalidCountError: "Select between 2 and 3 products to compare",
      someNotFoundError: "One or more of the selected products was not found",
      differentLinesWarning: "The selected products are not on the same product line",
      differentLinesDetail: "Comparison is only meaningful within the same product line. Product lines found: {lines}.",
      noLine: "No product line",
      sharedLineLabel: "Product line",
      differsIndicator: "Value differs between products",
    },
  },
  accessGate: {

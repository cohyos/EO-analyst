...
export const he = {
  ...
  dossiers: {
    ...
    sections: {
      ...
      deals: "עסקאות",
      pricing: "מחירים",
      pricingEstimate: "אומדן תמחור אנליטי (ביטחון נמוך)",
      partnerships: "שותפויות",
      competitors: "מתחרים",
      claimsReview: "ניתוח ביקורתי של טענות היצרן",
      patents: "פטנטים",
      tendersAndForecasts: "מכרזים ותחזיות",
      risksAndGaps: "פערים",
      gapsTracking: "מעקב פערים",
    ...
    table: {
      ...
      colEvidence: "עדות",
      colDomain: "תחום",
      colIntegrationEvidence: "עדות לשילוב",
      colEvent: "אירוע",
      colClaim: "טענה",
      colVerifiability: "מה יאמת",
      colComparability: "השוואתיות",
      colVerdict: "מסקנה",
      colGap: "פער",
      colMethod: "שיטה",
      colRange: "טווח אומדן",
      colComparableProduct: "מוצר להשוואה",
      colPriceRange: "טווח מחיר",
    },
    confidenceLevel: {
      high: "גבוה",
      medium: "בינוני",
    ...
    pricingEstimate: {
      disclaimer: "אומדן אנליטי, לא נתון ממקור",
      methodLabel: "שיטה",
      assumptionsLabel: "הנחות עבודה",
      marketAnchorsLabel: "עוגני שוק",
      rangeLabel: "טווח אומדן",
    },
    maturity: {
      trlLabel: "TRL",

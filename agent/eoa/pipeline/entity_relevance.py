...
_COUNTRY_NAMES = {
    ...
    "israel", "japan", "germany", "france", "italy", "spain", "portugal",
    "poland", "ukraine", "russia", "china", "india", "south korea", "north korea",
    "turkey", "türkiye", "canada", "australia", "new zealand", "brazil", "mexico",
    "egypt", "saudi arabia", "united arab emirates", "uae", "qatar", "jordan",
    "lebanon", "syria", "iran", "iraq", "pakistan", "taiwan", "vietnam",
    "philippines", "indonesia", "singapore", "thailand", "malaysia",
    "netherlands", "belgium", "norway", "sweden", "finland", "denmark",
    "switzerland", "austria", "greece", "czech republic", "czechia", "slovakia",
    "hungary", "romania", "bulgaria", "croatia", "serbia", "estonia", "latvia",
    "lithuania", "south africa", "nigeria", "kenya", "colombia", "chile",
    "argentina", "peru", "morocco", "algeria", "tunisia", "libya", "yemen",
    "bahrain", "kuwait", "oman", "azerbaijan", "georgia", "armenia", "kazakhstan",
    # Hebrew
    "ישראל", 'ארה"ב', "ארצות הברית", "יפן", "גרמניה", "צרפת", "בריטניה",
    "סין", "רוסיה", "הודו", "טורקיה", "קנדה", "מצרים", "ירדן",
}
...
_NEWS_SOURCE_NAMES = {
    "the war zone", "twz", "breaking defense", "defense news", "defensenews",
    "jane's", "janes", "jane's defence weekly", "reuters", "associated press",
    "ap news", "c4isrnet", "defense one", "aviation week", "aviationweek",
    "army technology", "naval technology", "naval news",
    "military times", "the drive", "bloomberg", "the wall street journal",
    "the new york times", "washington post", "politico", "axios", "cnn", "bbc",
    "afp", "flightglobal", "spacenews", "the diplomat",
    "unmanned systems technology", "shephard media", "dronexl", "defense update",
    "israel defense", "dvids",
...
def score_and_persist_entity(name: str) -> float | None:
    ...
    try:
        ...
        with connection() as conn:
            row = conn.execute(
                "SELECT id, kind, aliases FROM entities WHERE name = %s", (name,)
            ).fetchone()
        if row is None:
            return None
